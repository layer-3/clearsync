...
func TestNew(t *testing.T) {
	...
	testCases := []struct {
		...
		{common.DriverUniswapV3.String(), common.DriverUniswapV3, (*base.DEX[iuniswap_v3_pool.IUniswapV3PoolSwap, *iuniswap_v3_pool.IUniswapV3PoolSwapIterator])(nil)},
		{common.DriverSyncswap.String(), common.DriverSyncswap, (*base.DEX[isyncswap_pool.ISyncSwapPoolSwap, *isyncswap_pool.ISyncSwapPoolSwapIterator])(nil)},
		{common.DriverQuickswap.String(), common.DriverQuickswap, (*base.DEX[quickswap_v3_pool.IQuickswapV3PoolSwap, *quickswap_v3_pool.IQuickswapV3PoolSwapIterator])(nil)},
		{common.DriverSectaV2.String(), common.DriverSectaV2, (*base.DEX[isecta_v2_pair.ISectaV2PairSwap, *isecta_v2_pair.ISectaV2PairSwapIterator])(nil)},
		{common.DriverSectaV3.String(), common.DriverSectaV3, (*base.DEX[isecta_v3_pool.ISectaV3PoolSwap, *isecta_v3_pool.ISectaV3PoolSwapIterator])(nil)},
		{common.DriverLynexV2.String(), common.DriverLynexV2, (*base.DEX[ilynex_v2_pair.ILynexPairSwap, *ilynex_v2_pair.ILynexPairSwapIterator])(nil)},
		{common.DriverLynexV3.String(), common.DriverLynexV3, (*base.DEX[ilynex_v3_pool.ILynexV3PoolSwap, *ilynex_v3_pool.ILynexV3PoolSwapIterator])(nil)},
	}
