...
func TestNewDriver(t *testing.T) {
	...
	testCases := []struct {
		...
		{DriverLynexV2.String(), DriverLynexV2, (*baseDEX[ilynex_v2_pair.ILynexPairSwap, ilynex_v2_pair.ILynexPair, *ilynex_v2_pair.ILynexPairSwapIterator])(nil)},
		{DriverLynexV3.String(), DriverLynexV3, (*baseDEX[ilynex_v3_pool.ILynexV3PoolSwap, ilynex_v3_pool.ILynexV3Pool, *ilynex_v3_pool.ILynexV3PoolSwapIterator])(nil)},
	}
