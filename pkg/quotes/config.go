...
type SyncswapConfig struct {
	...
	StablePoolMarkets         []string     `yaml:"stable_pool_markets" env:"STABLE_POOL_MARKETS" env-default:"usdc/usdt"` // comma separated list of markets as in `usdc/usdt,btc/usdt`
	Filter                    FilterConfig `yaml:"filter" env-prefix:"FILTER_"`
}
