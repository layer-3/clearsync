...
func Test_EMA20(t *testing.T) {
	t.Run("Successful test", func(t *testing.T) {
		...
		exp := []float64{40000, 40000, 40190.47619, 40315.19274, 40666.12677, 40888.40041, 40803.79085, 40822.47743, 40934.62244, 41131.32506, 41214.05601, 41622.24115, 41562.98009, 41556.98199, 41599.17418, 41827.82426, 42225.17433, 42679.91963, 42996.11776, 43091.72559, 42987.75173}
...
func Test_IndexAggregator(t *testing.T) {
	t.Run("Successful test", func(t *testing.T) {
		...
		exp := []float64{40000, 40207.54717, 40466.24305, 40530.21098, 40941.96994, 40722.34661, 40788.43173, 40982.49411, 41098.56987, 41104.26589, 41107.33374, 41107.00358, 41277.3339, 41292.39911, 41839.88457, 42682.42649, 43596.62893, 43605.96679, 43637.13205, 43568.57095}
		require.Equal(t, exp, result)
	})
}
