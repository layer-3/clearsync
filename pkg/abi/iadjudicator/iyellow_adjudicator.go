...
func (_IYellowAdjudicator *IYellowAdjudicatorCaller) UnpackStatus(opts *bind.CallOpts, channelId [32]byte) (struct {
	TurnNumRecord *big.Int
	FinalizesAt   *big.Int
	Fingerprint   *big.Int
}, error) {
	var out []interface{}
	err := _IYellowAdjudicator.contract.Call(opts, &out, "unpackStatus", channelId)
...
//
// Solidity: function unpackStatus(bytes32 channelId) view returns(uint48 turnNumRecord, uint48 finalizesAt, uint160 fingerprint)
func (_IYellowAdjudicator *IYellowAdjudicatorSession) UnpackStatus(channelId [32]byte) (struct {
	TurnNumRecord *big.Int
	FinalizesAt   *big.Int
	Fingerprint   *big.Int
}, error) {
	return _IYellowAdjudicator.Contract.UnpackStatus(&_IYellowAdjudicator.CallOpts, channelId)
}

// UnpackStatus is a free data retrieval call binding the contract method 0x552cfa50.
//
// Solidity: function unpackStatus(bytes32 channelId) view returns(uint48 turnNumRecord, uint48 finalizesAt, uint160 fingerprint)
func (_IYellowAdjudicator *IYellowAdjudicatorCallerSession) UnpackStatus(channelId [32]byte) (struct {
	TurnNumRecord *big.Int
	FinalizesAt   *big.Int
	Fingerprint   *big.Int
}, error) {
...
type IYellowAdjudicatorCheckpointedIterator struct {
	Event *IYellowAdjudicatorCheckpointed // Event containing the contract specifics and raw log
...
func (it *IYellowAdjudicatorCheckpointedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IYellowAdjudicatorCheckpointed)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
type IYellowAdjudicatorCheckpointed struct {
	ChannelId        [32]byte
	NewTurnNumRecord *big.Int
	Raw              types.Log // Blockchain specific contextual infos
}
...
func (_IYellowAdjudicator *IYellowAdjudicatorFilterer) FilterCheckpointed(opts *bind.FilterOpts, channelId [][32]byte) (*IYellowAdjudicatorCheckpointedIterator, error) {
	...
	logs, sub, err := _IYellowAdjudicator.contract.FilterLogs(opts, "Checkpointed", channelIdRule)
	if err != nil {
		return nil, err
	}
	return &IYellowAdjudicatorCheckpointedIterator{contract: _IYellowAdjudicator.contract, event: "Checkpointed", logs: logs, sub: sub}, nil
}
...
func (_IYellowAdjudicator *IYellowAdjudicatorFilterer) WatchCheckpointed(opts *bind.WatchOpts, sink chan<- *IYellowAdjudicatorCheckpointed, channelId [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _IYellowAdjudicator.contract.WatchLogs(opts, "Checkpointed", channelIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IYellowAdjudicatorCheckpointed)
				if err := _IYellowAdjudicator.contract.UnpackLog(event, "Checkpointed", log); err != nil {
					return err
				}
				event.Raw = log
